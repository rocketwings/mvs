function [fig,err] = visualize_testing_linear(X,Y,Y_hat,r,X1,X2)
...
if isnan(r.b)
    title('Infeasible');
    if err > 0
        legend('True 1','True 2','Labeled 1','Labeled 2','label error');
    else
        legend('True 1','True 2','Labeled 1','Labeled 2');
    end
else 
    ...
    contour(x,y,f,[0,0],'-k');
    if err > 0 
        legend('True 1','True 2','Labeled 1','Labeled 2','label error','decision boundary');
    else
        legend('True 1','True 2','Labeled 1','Labeled 2','decision boundary');
    end 
